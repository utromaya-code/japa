// Проверенные фото Японии и маршрута (Commons, Pexels). Без снега и посторонних зданий.
export const galleryImages = [
  { src: 'images/kyoto-bamboo.jpg', alt: 'Киото, бамбуковая роща Арасияма' },
  ...
  { src: 'images/koyasan-okunoin.jpg', alt: 'Японский храм осенью' },
  ...
  { src: 'images/lake-toya.jpg', alt: 'Озеро Тойя, вид с побережья' },
  { src: 'images/tokyo-fuji.jpg', alt: 'Вид на Фудзи из Токио' },
  { src: 'images/otaru-canal.jpg', alt: 'Улица в Японии' },
]
