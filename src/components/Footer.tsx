...
export function Footer() {
  return (
    <footer className="bg-momiji-brown text-paper py-12 md:py-16">
      <div className="container mx-auto px-4 max-w-5xl">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-8">
          <p className="font-display text-lg text-paper/90 text-center md:text-left">
          ...
          <div className="flex gap-4">
            {social.map((item) => (
              <a
                ...
                className="p-2 text-paper/80 hover:text-momiji-gold transition-colors"
        ...
        <nav className="flex flex-wrap justify-center md:justify-start gap-4 md:gap-6 text-sm">
          {navLinks.map((link) => (
            <a
              key={link.href}
              href={link.href}
              className="text-paper/80 hover:text-momiji-gold transition-colors"
            >
              {link.label}
            </a>
          ))}
