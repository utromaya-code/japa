...
const included = [
  ...
  'Все переезды и трансферы',
  'Размещение (рёканы, отели, храм-сюкубо)',
  'Практики с Леонидом Кутузовым',
...
const excluded = [
  ...
  'Личные расходы',
  'Одноместное размещение — доплата 800 €',
]
...
const cards = [
  { icon: Calendar, label: 'Даты', value: '10–20 октября 2026' },
  {
    icon: Banknote,
    label: 'Стоимость',
    value: '4500 € при раннем бронировании (предоплата 2000 €, остаток по прилёту)',
  },
  {
    icon: Clock,
